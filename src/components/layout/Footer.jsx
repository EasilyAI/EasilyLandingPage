...
export const Footer = ({ t, withLangPath }) => (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 border-b border-gray-700 pb-12">
        <div className="col-span-1 md:col-span-1">
          <Link to={withLangPath ? withLangPath('/') : '/'} className="text-2xl font-black text-white mb-6 tracking-wider font-display block hover:text-[#817DFF] transition-colors">EASILY AI</Link>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li><Link to={withLangPath ? withLangPath('/services') : '/services'} className="hover:text-[#817DFF] transition-colors">All Services</Link></li>
            <li><Link to={withLangPath ? withLangPath('/ai-tools') : '/ai-tools'} className="hover:text-[#817DFF] transition-colors">{t.nav.ai_tools}</Link></li>
        ...
        <div>
           ...
           <ul className="space-y-3 text-sm">
             <li><Link to={withLangPath ? withLangPath('/contact') : '/contact'} className="hover:text-[#817DFF] transition-colors">Contact Us</Link></li>
